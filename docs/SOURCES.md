...
- [EARLY_MATERIALIZATION](https://docs.vertica.com/26.2.x/en/sql-reference/language-elements/hints/early-materialization/)
- [ECSMODE](https://docs.vertica.com/26.2.x/en/sql-reference/language-elements/hints/ecsmode/)
...
- [SKIP_STATISTICS](https://docs.vertica.com/26.2.x/en/sql-reference/language-elements/hints/skip-statistics/)
...
- [Outer joins](https://docs.vertica.com/26.2.x/en/data-analysis/queries/joins/outer-joins/)
...
- [GETUTCDATE](https://docs.vertica.com/26.2.x/en/sql-reference/functions/data-type-specific-functions/datetime-functions/getutcdate/)
